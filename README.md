...
│
├── asn1/
│   └── NR-RRC-Definitions.asn    # 3GPP TS 38.331 ASN.1 definitions
│
├── src/
│   ├── encoder.c                  # TCP client: builds & sends SIB1
│   └── decoder.c                  # TCP server: receives & decodes SIB1
│
├── generated/                     # Auto-generated by asn1c
│   ├── *.c                        # ASN.1 C implementation
│   └── *.h                        # ASN.1 C headers
│   
└── README.md                      # This file
```
...
│     ENCODER (TCP CLIENT)          │
├──────────────────────────────────┤
│ 1. Build SIB1 Structure          │
│ 2. Populate Fields               │
│ 3. PER Encode → Binary           │
│ 4. socket()                      │
│ 5. connect(SERVER_IP:8888)       │──TCP──┐
│ 6. send(encoded_data, 47)        │       │
│ 7. close()                       │       │
└──────────────────────────────────┘       │
                                            │
                                            ▼
...
│ 4. accept() ← Client             │
│ 5. recv(buffer, 1024)            │
│ 6. PER Decode → Structure        │
│ 7. Extract & Print Fields        │
│ 8. close()                       │
└──────────────────────────────────┘
```
