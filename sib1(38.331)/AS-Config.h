...
/* Dependencies */
typedef enum AS_Config__sourceSCG_Configured {
	AS_Config__sourceSCG_Configured_true	= 0
} e_AS_Config__sourceSCG_Configured;
...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_sourceSCG_Configured_7;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_AS_Config;
extern asn_SEQUENCE_specifics_t asn_SPC_AS_Config_specs_1;
extern asn_TYPE_member_t asn_MBR_AS_Config_1[5];
