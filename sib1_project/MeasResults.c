...
asn_TYPE_member_t asn_MBR_MeasResults_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct MeasResults, measResultNeighCells),
	...
	{ ATF_POINTER, 5, offsetof(struct MeasResults, measResultServFreqListEUTRA_SCG),
	...
	{ ATF_POINTER, 4, offsetof(struct MeasResults, measResultServFreqListNR_SCG),
	...
	{ ATF_POINTER, 3, offsetof(struct MeasResults, measResultSFTD_EUTRA),
	...
	{ ATF_POINTER, 2, offsetof(struct MeasResults, measResultSFTD_NR),
	...
	{ ATF_POINTER, 1, offsetof(struct MeasResults, measResultCellListSFTD_NR),
...
static const int asn_MAP_MeasResults_oms_1[] = { 2, 3, 4, 5, 6, 7 };
