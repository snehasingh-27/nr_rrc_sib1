...
static asn_oer_constraints_t asn_OER_memb_lateNonCriticalExtension_constr_13 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
static asn_TYPE_member_t asn_MBR_UE_MRDC_Capability_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct UE_MRDC_Capability, lateNonCriticalExtension),
		...
		0,
		{ &asn_OER_memb_lateNonCriticalExtension_constr_13, &asn_PER_memb_lateNonCriticalExtension_constr_13,  memb_lateNonCriticalExtension_constraint_1 },
		0, 0, /* No default value */
