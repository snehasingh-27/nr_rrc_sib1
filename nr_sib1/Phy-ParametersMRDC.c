...
asn_TYPE_member_t asn_MBR_Phy_ParametersMRDC_1[] = {
	{ ATF_POINTER, 2, offsetof(struct Phy_ParametersMRDC, naics_Capability_List),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct Phy_ParametersMRDC, spCellPlacement),
...
static const int asn_MAP_Phy_ParametersMRDC_oms_1[] = { 0, 1 };
